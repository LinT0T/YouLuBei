...
public class LeftSlideView extends HorizontalScrollView {
    ...
    private TextView mTextViewSet;//设置按钮

    private TextView mTextViewFinish;//删除按钮
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!once) {
            mTextViewFinish = findViewById(R.id.tv_delete);
            mTextViewSet = findViewById(R.id.tv_set);
            once = true;
        }
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        //改变view的在x轴方向的位置
        mTextViewSet.setTranslationX(1);
    }
